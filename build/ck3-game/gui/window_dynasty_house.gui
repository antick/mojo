		...
		vbox = {
			...
			vbox = {
				...
				hbox = {
					...
					vbox = {
						...
						hbox = {
							visible = "[And( InDebugMode, DynastyHouse.HasHouseTitle )]"

							layoutpolicy_horizontal = expanding
							margin_left = 25

							datacontext = "[DynastyHouse.GetHouseTitle]"

							text_multi = {
								raw_text =  "#D House Title: [Title.GetName|U] #D"
								maximumsize = { 350 60 }
								max_width = 350
								autoresize = yes
							}
						...
						hbox_access_domicile_button = {
							...
							vbox = {
								...
								hbox = {
									layoutpolicy_horizontal = expanding
									text_single = {
										text = "[DynastyHouseView.GetDomicileTitle]"
								...
								hbox = {
									layoutpolicy_horizontal = expanding
									text_single = {
										text = "[DynastyHouseView.GetDomicileLocation]"
									}
									expand = {}
								}
								expand = {}
			...
			hbox = {
				...
				vbox = {
					...
					text_single = {
						layoutpolicy_horizontal = expanding
						text = "HOUSE_VIEW_POWERFUL_FAMILY_ATTRIBUTE"
					}
